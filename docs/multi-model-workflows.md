...
That sets base URL `http://localhost:11434/v1`, key `ollama`, and enables the tags. Switch model in the chat model picker — only one generates at a time unless you open multiple chats/agents.
